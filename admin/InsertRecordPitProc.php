...
if($_SESSION['admin']){
	...
	if($_GET['league']=="골드매직"){
		...
		$main_url = "http://www.gdbl.or.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=29&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%B8%C5%C1%F7%B8%AE%B1%D7&mGubun=4";
		...
		$main_url = "http://www.gjba.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=21&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%B1%DD%C1%A4%B8%AE%B1%D7&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$main_url = "http://alb.or.kr/s/stand_pit/index.php?id=stats&league=%BF%AC%C7%D5%C8%B8%C0%E5%B1%E2&sc=2&gyear=".$_GET['year']."&division=&order=win&sort=desc&mode=total";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
	...
	// 3 안양리그 끝		
		...
		$league_row = mysqli_fetch_array($league_result);
		$snoopy->referer = "http://www.gdbl.or.kr";
		$main_url = "http://www.gdbl.or.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=29&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%BE%C6%B8%DE%B8%AE%C4%AD%B8%AE%B1%D7&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$league_row = mysqli_fetch_array($league_result);
		$snoopy->referer = "http://www.gdbl.or.kr";
		$main_url = "http://www.gdbl.or.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=29&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%B3%BB%BC%C5%B3%CE%B8%AE%B1%D7&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$league_row = mysqli_fetch_array($league_result);
		$snoopy->referer = "http://www.gdbl.or.kr";
		$main_url = "http://www.gdbl.or.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=29&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%B5%E5%B8%B2%B8%AE%B1%D7&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$main_url = "http://sdbl.or.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=30&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%B3%BB%BC%C5%B3%CE%B8%AE%B1%D7&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$league_row = mysqli_fetch_array($league_result);
		$snoopy->referer = "http://sdbl.or.kr";
		$main_url = "http://sdbl.or.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=30&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%B8%C5%C1%F7%B8%AE%B1%D7&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$league_row = mysqli_fetch_array($league_result);
		$snoopy->referer = "http://sdbl.or.kr";
		$main_url = "http://sdbl.or.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=30&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%B5%E5%B8%B2%B8%AE%B1%D7&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$league_row = mysqli_fetch_array($league_result);
		$snoopy->referer = "http://sdbl.or.kr";
		$main_url = "http://sdbl.or.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=30&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%C3%BF%B8%B0%C1%F6%B8%AE%B1%D7&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$league_row = mysqli_fetch_array($league_result);
		$snoopy->referer = "http://sdbl.or.kr";
		$main_url = "http://sdbl.or.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=30&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%BE%C6%B8%DE%B8%AE%C4%AD%B8%AE%B1%D7&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$main_url = "http://www.ksbbl.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=17&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%B0%B3%BC%BA%B8%AE%B1%D7&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		...
		$league_row = mysqli_fetch_array($league_result);
		$snoopy->referer = "http://www.ksbbl.kr";
		$main_url = "http://www.ksbbl.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=17&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%B0%B3%BC%BA%B8%AE%B1%D7%201%BA%CE&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$league_row = mysqli_fetch_array($league_result);
		$snoopy->referer = "http://www.ksbbl.kr";
		$main_url = "http://www.ksbbl.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=17&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%B0%B3%BC%BA%B8%AE%B1%D7%202%BA%CE&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$main_url = "http://www.kjba.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=38&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%C5%E4%BF%E4%B8%AE%B1%D7&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$league_row = mysqli_fetch_array($league_result);
		$snoopy->referer = "http://www.kjba.kr";
		$main_url = "http://www.kjba.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=37&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=1%BA%CE%B8%AE%B1%D7&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$league_row = mysqli_fetch_array($league_result);
		$snoopy->referer = "http://www.kjba.kr";
		$main_url = "http://www.kjba.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=37&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=2%BA%CE%B8%AE%B1%D7&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$league_row = mysqli_fetch_array($league_result);
		$snoopy->referer = "http://www.kjba.kr";
		$main_url = "http://www.kjba.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=37&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=3%BA%CE%B8%AE%B1%D7&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$league_row = mysqli_fetch_array($league_result);
		$snoopy->referer = "http://www.kjba.kr";
		$main_url = "http://www.kjba.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=37&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%B7%E7%C5%B0%B8%AE%B1%D7&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$main_url = "http://www.mybl.or.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=23&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%B9%D0%BE%E7%B8%AE%B1%D7&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$pattern3 = '/memID=(.*?)teamName/is';
		preg_match_all($pattern3, $matches[0][0], $matches3, PREG_PATTERN_ORDER);
		for($i=0; $i<(count($matches2[0]) - 18)/19; $i++){
			$x = $i * 19 + 18;
		...
		$league_row = mysqli_fetch_array($league_result);
		$snoopy->referer = "http://www.mybl.or.kr";
		$main_url = "http://www.mybl.or.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=25&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%C5%E4%BF%E4%B3%AA%B3%EB%B8%AE%B1%D7&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$league_row = mysqli_fetch_array($league_result);
		$snoopy->referer = "http://www.mybl.or.kr";
		$main_url = "http://www.mybl.or.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=36&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%C6%F2%C0%CF%BE%DF%B0%A3%B8%AE%B1%D7&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$league_row = mysqli_fetch_array($league_result);
		$snoopy->referer = "http://www.mybl.or.kr";
		$main_url = "http://www.mybl.or.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=23&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%C0%CF%BF%E41%BA%CE&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$league_row = mysqli_fetch_array($league_result);
		$snoopy->referer = "http://www.mybl.or.kr";
		$main_url = "http://www.mybl.or.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=23&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%C0%CF%BF%E4%B5%E5%B8%B2%B8%AE%B1%D7&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$league_row = mysqli_fetch_array($league_result);
		$snoopy->referer = "http://www.mybl.or.kr";
		$main_url = "http://www.mybl.or.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=23&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%C0%CF%BF%E4%B8%C5%C1%F7%B8%AE%B1%D7&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$league_row = mysqli_fetch_array($league_result);
		$snoopy->referer = "http://www.mybl.or.kr";
		$main_url = "http://www.mybl.or.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=23&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%C0%CF%BF%E43%BA%CE%20%B5%E5%B8%B2&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$league_row = mysqli_fetch_array($league_result);
		$snoopy->referer = "http://www.mybl.or.kr";
		$main_url = "http://www.mybl.or.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=23&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%C0%CF%BF%E43%BA%CE%20%B8%C5%C1%F7&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$main_url = "http://www.byba.or.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=06&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%B9%E9%BE%E7%B8%AE%B1%D7&mGubun=1";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$league_row = mysqli_fetch_array($league_result);
		$snoopy->referer = "http://www.byba.or.kr";
		$main_url = "http://www.byba.or.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=06&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%B9%E9%BE%E7%B8%AE%B1%D7&mGubun=2";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		...
		$main_url = "http://shi-baseball.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=24&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%C1%DF%BF%EC%C8%B8%C0%E5%B9%E8%B8%AE%B1%D7&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		...
		$main_url = "http://www.bspil.net/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=11&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%C6%F2%C0%CF%B8%AE%B1%D7&mGubun=4";
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		...
		if($_GET['league2'] == "무룡A"){
			...
			$main_url = "http://www.usba.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=15&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%B9%AB%B7%E6%B8%AE%B1%D7%20A&mGubun=4";
			...
			$main_url = "http://www.usba.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=15&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%B9%AB%B7%E6%B8%AE%B1%D7%20B&mGubun=4";
			...
			$main_url = "http://www.usba.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=15&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%B9%AB%B7%E6%B8%AE%B1%D7&mGubun=4";
			...
			$main_url = "http://www.usba.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=15&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%BC%AD%BA%CE%B8%AE%B1%D7&mGubun=4";
			...
			$main_url = "http://www.usba.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=15&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%BA%CF%BA%CE%B8%AE%B1%D7&mGubun=4";
			...
			$main_url = "http://www.usba.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=16&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%C3%B3%BF%EB%B8%AE%B1%D7%20A&mGubun=4";
			...
			$main_url = "http://www.usba.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=16&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%C3%B3%BF%EB%B8%AE%B1%D7%20B&mGubun=4";
			...
			$main_url = "http://www.usba.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=16&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%C5%C2%C8%AD%B8%AE%B1%D7&mGubun=4";
			...
			$main_url = "http://www.usba.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=16&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%B9%AE%BC%F6%B8%AE%B1%D7&mGubun=4";
			...
			$main_url = "http://www.usba.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=16&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%B5%BF%BA%CE%B8%AE%B1%D7&mGubun=4";
			...
			$main_url = "http://www.usba.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=16&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%B3%B2%BA%CE%B8%AE%B1%D7&mGubun=4";
		}
		$league_result = mysqli_query($conn,$league_query);
		$league_row = mysqli_fetch_array($league_result);
		$snoopy->referer = "http://www.bspil.net";
		...
		if($_GET['league2'] == "내셔널"){
			...
			$main_url = "http://www.usmlb.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=32&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%B3%BB%BC%C5%B3%CE%B8%AE%B1%D7&mGubun=4";
			...
			$main_url = "http://www.usmlb.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=33&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%BE%C6%B8%DE%B8%AE%C4%AD%B8%AE%B1%D7&mGubun=4";
			...
			$main_url = "http://www.usmlb.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=33&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%BE%C6%B8%DE%B8%AE%C4%AD%B8%AE%B1%D7A&mGubun=4";
			...
			$main_url = "http://www.usmlb.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=33&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%BE%C6%B8%DE%B8%AE%C4%AD%B8%AE%B1%D7B&mGubun=4";
		}
		$league_result = mysqli_query($conn,$league_query);
		$league_row = mysqli_fetch_array($league_result);
		...
		$snoopy->fetch($main_url);
		$html = iconv('EUC-KR', 'UTF-8', $snoopy->results);
		$pattern = '/<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top:3px;" class="tblTopBorder">(.*?)<\/table>/is';
		preg_match_all($pattern, $html, $matches, PREG_PATTERN_ORDER);
		$pattern2 = '/<td(.*?)>(.*?)<\/td>/is';
		preg_match_all($pattern2, $matches[0][0], $matches2, PREG_PATTERN_ORDER);
		$pattern3 = '/memID=(.*?)teamName/is';
		...
		$main_url = "http://www.sukdaeba.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=12&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=%C7%D1%BB%F5%B9%FA%B8%AE%B1%D7&mGubun=4";
		$league_result = mysqli_query($conn,$league_query);
		$league_row = mysqli_fetch_array($league_result);
		...
		$main_url = "http://www.bpabaseball.kr/pitcherRankDetail.asp?yy=".$_GET['year']."&groupCode=27&gameName=%C1%A4%B1%D4%B8%AE%B1%D7&league=BPA%B8%AE%B1%D7&mGubun=4";
		$league_result = mysqli_query($conn,$league_query);
		$league_row = mysqli_fetch_array($league_result);
		...
		if($_GET['league2'] == '매직선수'){
			...
			$main_url = "http://www.psba.or.kr/detailPitcherRank.asp?gubun=1&yy=".$_GET['year']."&league=%B8%C5%C1%F7%B8%AE%B1%D7&kind=Sun";
			...
			$main_url = "http://www.psba.or.kr/detailPitcherRank.asp?gubun=2&yy=".$_GET['year']."&league=%B8%C5%C1%F7%B8%AE%B1%D7&kind=Sun";
			...
			$main_url = "http://www.psba.or.kr/detailPitcherRank.asp?gubun=4&yy=".$_GET['year']."&league=%B5%E5%B8%B2%B8%AE%B1%D7&kind=Sun";
		}
		$league_result = mysqli_query($conn,$league_query);
		$league_row = mysqli_fetch_array($league_result);
